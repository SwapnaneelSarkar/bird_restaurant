// lib/presentation/screens/delivery_partner_pages/chat/state.dart - ENHANCED WITH READ STATUS
...
class DeliveryPartnerChatInitial extends DeliveryPartnerChatState {}

class DeliveryPartnerChatLoading extends DeliveryPartnerChatState {}

class DeliveryPartnerChatLoaded extends DeliveryPartnerChatState {
  ...
  const DeliveryPartnerChatLoaded({
  ...
  DeliveryPartnerChatLoaded copyWith({
    ChatOrderInfo? orderInfo,
    List<DeliveryPartnerChatMessage>? messages,
    bool? isConnected,
    bool? isRefreshing,
    ...
    return DeliveryPartnerChatLoaded(
...
class DeliveryPartnerChatError extends DeliveryPartnerChatState {
  final String message;

  const DeliveryPartnerChatError(this.message);

  @override
  List<Object> get props => [message];
}

class DeliveryPartnerChatSuccess extends DeliveryPartnerChatState {
  final String message;

  const DeliveryPartnerChatSuccess(this.message);
...
class OrderOptionsVisible extends DeliveryPartnerChatState {
...
class OrderDetailsLoading extends DeliveryPartnerChatState {}

class OrderDetailsLoaded extends DeliveryPartnerChatState {
  final OrderDetails orderDetails;
  final Map<String, MenuItem>? menuItems;
...
class OrderDetailsError extends DeliveryPartnerChatState {
  final String message;
...
// ENHANCED: DeliveryPartnerChatMessage with read status
class DeliveryPartnerChatMessage {
  final String id;
  final String message;
  final bool isUserMessage;
  final String time;
  final bool isRead; // Read status for blue/grey ticks

  const DeliveryPartnerChatMessage({
    required this.id,
  ...
  DeliveryPartnerChatMessage copyWith({
    String? id,
    String? message,
    bool? isUserMessage,
    String? time,
